...
public final class BannerTopToDown: UIView {
    ...
    func setAddView(title:String? = "", details:String? = "", image:UIImage? = nil) {
        ...
        var topAnchorConstraintBannerCell:NSLayoutConstraint?
        ...
        topAnchorConstraintBannerCell = bannerCell.topAnchor.constraint(equalTo: backGroundView.topAnchor, constant: -bannerViewHeight)
